...
export default function Invitation({ onNext }) {
  ...
  return (
    ...
    >
      ...
      {/* SECCIÓN DE PADRES E IMAGEN (Ajustado con Flexbox) */}
      <motion.div variants={item} className="w-full max-w-[95%] md:max-w-3xl mb-8 relative z-30 px-2">
        <p className="text-[11px] md:text-xs uppercase tracking-[0.2em] text-[#4A5D23] mb-8 text-center">
          Con la bendición de nuestros padres
        </p>

        {/* Contenedor Flex Responsivo */}
        <div className="flex flex-row justify-center items-start w-full gap-2 md:gap-8">
          
          {/* Columna Izquierda: Padres del Novio */}
          <div className="flex-1 flex flex-col items-center text-center">
            <p className="mb-2 font-sans font-bold text-[#C5A059] text-[8px] md:text-[9px] uppercase tracking-widest">Padres del Novio</p>
            <p className="font-serif text-[11px] md:text-[14px] text-stone-700 leading-relaxed">
              Edson Mario Crespo Renfijo<br />
              Nora Flores Torrez
            </p>
          </div>

          {/* Columna Central: Espíritu Santo */}
          <div className="w-16 md:w-28 flex-shrink-0 flex justify-center -mt-2 md:-mt-4">
            <motion.img 
              initial={{ opacity: 0, scale: 0.8 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 2, ease: "easeOut" }}
              src="/EspirituSanto_2.png" 
              alt="Espíritu Santo" 
              className="w-full h-auto object-contain opacity-95"
              style={{ filter: "sepia(1) hue-rotate(15deg) saturate(1.8) brightness(1.2)" }}
          ...
          <div className="flex-1 flex flex-col items-center text-center">
            <p className="mb-2 font-sans font-bold text-[#C5A059] text-[8px] md:text-[9px] uppercase tracking-widest">Padres de la Novia</p>
            <p className="font-serif text-[11px] md:text-[14px] text-stone-700 leading-relaxed">
              Mario Demetrio Jimenez Galindo<br />
              Lucia Santa Cruz Gonzales
            </p>
          </div>
        </div>
        ...
        <div className="text-center w-full mt-8 border-t border-[#C5A059]/20 pt-6">
            ...
            <p className="text-sm md:text-base font-serif text-stone-700">Beatriz Renfijo Torrico</p>
        </div>
         ...
         <p className="font-serif italic text-xl md:text-2xl text-stone-600 leading-relaxed max-w-md mx-auto">
